...
<%@ Import Namespace="RecordDAL" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="/js/GetRecord.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                   ...
                   <ItemTemplate>
                       ...
                       <tr>
                           <td colspan="2"><input type="button" class="btn btn-primary" id="biographyButton" value="Biography:" />
                                <div id="biography"><%=ShowBiography() %></div><br/>
                                <br/>
                           </td>
                       </tr> 
                       <tr>
                       ...
                       <tr>
                           <td colspan="2"><input type="button" class="btn btn-primary" id="showButton" value="Review:" />
                                <div id="review"><%# Eval("Review") %></div><br/>
                                <br/>
                           </td>
                       </tr>
                       <tr>
  ...
  <div class="row">
    ...
    <asp:Label ID="yearLabel" runat="server"></asp:Label><br/><br/>   
                <asp:ObjectDataSource ID="recordObjectDataSource" TypeName="RecordDAL.RecordData" SelectMethod="Select" runat="server">
                    <SelectParameters>                                            
