    ...
    public partial class Search : System.Web.UI.Page
    {
        ...
        protected void searchButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                artistId = string.IsNullOrEmpty(artist.FirstName) ? artistData.GetArtistId(string.Empty, artist.FirstName) : artistData.GetArtistId(artist.FirstName, artist.LastName);
