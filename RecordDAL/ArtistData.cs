    ...
    public class ArtistData
    {
        ...
        public int Insert(Artist artist)
        {
            ...
            using (var cn = new SqlConnection(AppSettings.Instance.ConnectString))
            {
                ...
                cmd.Parameters.AddWithValue("fName", artist.FirstName);
                cmd.Parameters.AddWithValue("lName", artist.LastName);
        ...
        public int GetArtistId(string firstName, string lastName)
        {
            ...
            using (var cn = new SqlConnection(AppSettings.Instance.ConnectString))
            {
                ...
                cmd.Parameters.AddWithValue("fName", string.IsNullOrEmpty(firstName) ? null : firstName);
                cmd.Parameters.AddWithValue("lName", lastName);
